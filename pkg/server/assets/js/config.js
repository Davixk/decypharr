...
class ConfigManager {
    ...
    collectUsenetConfig() {
        ...
        return {
            ...
            read_timeout: document.querySelector('[name="usenet.read_timeout"]')?.value || "30s",
            download_timeout: document.querySelector('[name="usenet.download_timeout"]')?.value || "60s",
    ...
    populateUsenetSettings(usenet) {
        ...
        const streamFields = {
            ...
            'read_timeout': usenet.read_timeout,
            'download_timeout': usenet.download_timeout,
