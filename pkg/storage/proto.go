...
func EntryToProto(e *Entry) *EntryProto {
	pb := &EntryProto{
		...
		MainStoreGeneration:  e.mainStoreGeneration,
		MainStoreRevision:    e.mainStoreRevision,
		QueueStoreGeneration: e.queueStoreGeneration,
		QueueStoreRevision:   e.queueStoreRevision,
	}
...
func ProtoToEntry(pb *EntryProto) *Entry {
	e := &Entry{
		...
		Bytes:                pb.Bytes,
		Magnet:               pb.Magnet,
		NZBGeneration:        pb.NzbGeneration,
		...
		mainStoreGeneration:  pb.MainStoreGeneration,
		mainStoreRevision:    pb.MainStoreRevision,
		queueStoreGeneration: pb.QueueStoreGeneration,
		queueStoreRevision:   pb.QueueStoreRevision,
	}
